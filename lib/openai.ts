...
const PROMPT = `You are EverWhy. Identify the single most prominent object in this image — a man-made thing (sign, building, tool, vehicle) or a natural one (plant, rock, animal).
...
const WHY_SYSTEM = `You are the Why Engine inside EverWhy — a curiosity tool that explores why things exist through recursive questioning. Given a topic and the chain of why-questions and answers so far, produce the SINGLE next "why" question that digs one causal layer deeper than the most recent answer, plus a concise, accurate answer to it.
    ...
    [
      {
        role: "system",
        content:
          "You are EverWhy. Explain what something is and why it exists, in the same concise format used for scanned objects.",
      },
      {
        role: "user",
    ...
    [
      {
        role: "system",
        content:
          "You are EverWhy's daily discovery. For a calendar date, surface genuinely notable things tied to that date in history.",
      },
      {
        role: "user",
